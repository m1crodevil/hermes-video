...
from watch.config import DEFAULT_MIN_MOMENTS, frame_cap, get_config  # noqa: E402
from watch.download import download, fetch_captions, is_url  # noqa: E402
from watch.download import download_sections_parallel  # noqa: E402
from watch.frames import MAX_FPS, auto_fps, auto_fps_focus, extract_at_timestamps, extract_from_sections, extract_keyframes, extract_scene_or_uniform, extract_two_pass, format_time, get_metadata, merge_frames, parse_time, parse_timestamps  # noqa: E402
...
def main() -> int:
    ...
    if max_frames is not None and max_frames > 10000:
        max_frames = 10000
